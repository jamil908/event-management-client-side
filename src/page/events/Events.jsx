...
//     fetch(`http://localhost:5000/join-event/${eventId}`, {
//       method: "POST",
//     })
//       .then((res) => res.json())
//       .then(() => {
//         // Emit the event to notify the server that a participant has joined
//         socket.emit("joinEvent", eventId);

//         // Update the local event list optimistically by finding and updating the relevant event
